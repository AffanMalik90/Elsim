...
INPFS = 'GrMic_II_DS_186x1460x320_B105.dat'
INPFL = 'GrMic_II_DL_186x1460x320_B105.dat'
OUTPF = 'GBQ105'
...
OPEN(UNIT=20,FILE='/mnt/scratch/hcy/SBMES_2022/2022_1225_A/Geom_T/H_qt_3/'//INPFS, &
...
OPEN(UNIT=20,FILE='/mnt/scratch/hcy/SBMES_2022/2022_1225_A/Geom_T/H_qt_3/'//INPFL, &
	FORM='UNFORMATTED',STATUS='OLD',ACTION='READ')
	READ(20) DmyT(1:gy,1:gx,1:gz)	
CLOSE(20)
...
SELECT CASE (AB)
	...
	CASE (2)
		flnm = prfn//fs//'.dat'
		OPEN(UNIT=20,FILE='/mnt/gs21/scratch/hcy/SBMES_2022/2022_0720_A/DataCH1/'//flnm, &
