...
! 0.5C
BvE = -0.4686 				!! Boundary condition for phE
! 0.1C
! BvE = -0.47186 				!! Boundary condition for phE
...
Vsr0 = 1.0d-2 * 1.0d1 /(3.25**2)
! Vsr0 = 1.0d-2 * 1.0d1 /(3.25**2) *10
...
ALLOCATE(DmyD(1:81,1:81,1:6) )
OPEN(UNIT=20,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/'// &
	'Geom/DSTFB_81x81x6.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
	READ(20,*) DmyD(1:81,1:81,1:6)
CLOSE(20)
GLP(1:gy,1:gx,1:gz) = DmyD(1:gy,1:gx,1+0:gz+0)
GLP(1:gy,1:gx,1:gz) = 0.5*(1.0+TANH(GLP(1:gy,1:gx,1:gz)/zeta))

! OPEN(UNIT=20,FILE='/mnt/scratch/hcy/SBMES_3D_2020/2020_1119_A/Geom/GRP_3D_500x250x520_A_IV_CNCHK.dat', &
! 	FORM='UNFORMATTED',STATUS='OLD',ACTION='READ')
! 	READ(20) DmyT(1:500,1:250,1:520)
! CLOSE(20)
! GLP(1:gy,1:gx,1:gz) = DBLE(DmyT(1:gy,1:gx,1+0:gz+0))
...
OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_X_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
READ(10,*) Tbl(1,1:101)
CLOSE(10)

OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_M6_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
READ(10,*) Tbl(2,1:101)
CLOSE(10)
...
OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_X_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
READ(10,*) iTbl(1,1:101)
CLOSE(10)

OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_J2_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
...
OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_X_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
READ(10,*) OTbl(1,1:101)
CLOSE(10)

OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_O3_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
...
OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_X_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
READ(10,*) DTbl(1,1:101)
CLOSE(10)

OPEN(UNIT=10,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk/Data/C_Li_Mb5_101.txt', &
	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
...
ALLOCATE(GLE(0:gy+1,0:gx+1,0:gz+1) )
! OPEN(UNIT=20,FILE='/mnt/scratch/hcy/SBMES_3D_2020/2020_1119_A/Geom/POR_3D_500x250x520_A_IV_CNCHK.dat', &
! 	FORM='UNFORMATTED',STATUS='OLD',ACTION='READ')
! 	READ(20) DmyT(1:500,1:250,1:520)
! CLOSE(20)
! GLE(1:gy,1:gx,1:gz) = DBLE(DmyT(1:gy,1:gx,1+0:gz+0))

! OPEN(UNIT=20,FILE='/mnt/home/malikaff/Project/CodeDir/Anode/disk'// &
! 	'Geom/GrMic_II_DL_500x220x170_X.txt', &
! 	FORM='FORMATTED',STATUS='OLD',ACTION='READ')
! 	READ(20,*) DmyD(1:81,1:81,1:6)
! CLOSE(20)
! GLE(1:gy,1:gx,1:gz) = DmyD(1:gy,1:gx,1+0:gz+0)
! GLE(1:gy,1:gx,1:gz) = 0.5*(1.0+TANH(GLE(1:gy,1:gx,1:gz)/zeta))

! WHERE ( GLE(1:gy,1:gx,1:gz) < 0.0 ) GLE(1:gy,1:gx,1:gz) = 0.0d0
! WHERE ( GLE(1:gy,1:gx,1:gz) > 1.0 ) GLE(1:gy,1:gx,1:gz) = 1.0d0

! GLE(0,1:gx,1:gz) = GLE(1,1:gx,1:gz)
! GLE(gy+1,1:gx,1:gz) = GLE(gy,1:gx,1:gz)
! GLE(0:gy+1,0,1:gz) = GLE(0:gy+1,1,1:gz)
! GLE(0:gy+1,gx+1,1:gz) = GLE(0:gy+1,gx,1:gz)
! GLE(0:gy+1,0:gx+1,0) = GLE(0:gy+1,0:gx+1,1)
! GLE(0:gy+1,0:gx+1,gz+1) = GLE(0:gy+1,0:gx+1,gz)

! psE(1:ny,1:nx,1:nz) = GLE(lwy:upy,1:gx,lwz:upz)
psE(1:ny,1:nx,1:nz) = 1.0d0 - psP(1:ny,1:nx,1:nz)
...
! 	CnE(0:ny+1,0,0:nz+1) = infx*t_minus*dx/De + CnE(0:ny+1,1,0:nz+1)
	...
	CnE(0:ny+1,nx+1,0:nz+1) = infx*t_minus*dx/(0.5*(Dab(0:ny+1,nx,0:nz+1)+Dab(0:ny+1,nx+1,0:nz+1))) + CnE(0:ny+1,nx,0:nz+1)
...
! 		CALL OutPut3D_A(cnt, ny, nx, nz, 'PD'//RkNb, 2, dPh(1:ny,1:nx,1:nz))
		...
		IF ( rank == 0 ) THEN
			CALL ReC_TmFX(cnt, 'GRDCVD', iter, tm, Xrf, sCrnt, trgI, BvE)
		ENDIF

		cnt = cnt + 1
	ENDIF
	
	IF ( BvE >= BvP +0.005 .OR. Xrf > 0.97 ) EXIT
...
SELECT CASE (AB)
	...
	CASE (2)
		flnm = prfn//fs//'.dat'
		OPEN(UNIT=20,FILE='/mnt/home/malikaff/scratch/Anode/Data/PRunGr/disk/DSTA/Data_R1/'//flnm, &
